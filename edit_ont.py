...
path.append("/home/test/python_modules/")
...
def kansas_city_shuffle(id: str, sn: str):
    service = put(f"https://{SMX}.10:18443/rest/v1/config/device/{cvec.name}/ont?action=replace&ont-id={id}&serial-number=CXNK{sn}",
